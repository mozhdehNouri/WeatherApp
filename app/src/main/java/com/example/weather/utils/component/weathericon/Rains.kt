...
@Composable
private fun AnimatableRaindrop(
    modifier: Modifier = Modifier,
    durationMillis: Int = 800
) {

    val transition =
        rememberInfiniteTransition(label = "raindrop_transition")
...
@Composable
private fun Raindrop(
    modifier: Modifier = Modifier,
    spacePosition: Float = 0f
) {
    Canvas(modifier) {
...
fun Rains(
    ...
    Layout(
        ...
        layout(constraints.maxWidth, constraints.maxHeight) {
            ...
            var xPosition =
                constraints.maxWidth / ((placeables.size + 1) * 2)

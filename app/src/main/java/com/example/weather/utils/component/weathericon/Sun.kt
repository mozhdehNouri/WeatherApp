...
import com.example.weather.theme.clearSky_dark_primary
import com.example.weather.theme.clearSky_dark_tertiaryContainer
...
fun AnimatableSun(modifier: Modifier = Modifier) {
    ...
    val animateTween by transition.animateFloat(
        initialValue = 0f,
        targetValue = 360f,
        animationSpec = infiniteRepeatable(tween(5000), RepeatMode.Reverse), label = "sun_tween"
    )
